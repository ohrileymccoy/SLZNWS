...
export function AdBanner() {
  ...
  data-ad-slot="1234567890"   // ⚠️ must be a real slot ID from your AdSense account
  data-ad-format="horizontal" // instead of "auto"
  data-ad-layout="in-article" // or pick matching type
