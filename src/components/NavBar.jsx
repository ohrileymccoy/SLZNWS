...
>
      ...
      {/* Mobile nav pills below brand & button */}
      <div className="flex justify-center gap-4 py-2 border-t border-neutral-800 text-xs md:hidden">
        <Link
          to="/"
